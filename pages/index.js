  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>This dashboard admin engine makes it easy for all your freelance clients to easily edit page content in your next.js apps and only takes a few minutest to set up!  Be sure to check out the <a href="https://github.com/holyaustin/nextjs-frontend">github repo</a> for instructions to add it to your app.</p>
